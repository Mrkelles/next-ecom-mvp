...
export function CheckoutForm({product, clientSecret}: CheckoutFormProps) {
    return (
        <>
        <div className="w-full mx-auto mt-6 p-6 lg:flex justify-between">
            <div className="flex lg:flex-col lg:gap-4 items-center lg:w-1/2">
            ...
            <div className="lg:w-1/2 mt-4 pt-8 lg:pt-4">
...
function Form({priceInCents, productId}: { priceInCents: number, productId:string }) {
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        stripe.confirmPayment({
            elements,
            confirmParams: { return_url: `${process.env.NEXT_PUBLIC_SERVER_URL}/stripe/success`
        },
    }).then(({error}) => {
              ...
              <Card>
                ...
                <CardFooter>
                    <Button 
                     ...
                     >{isLoading? "Purchasing" : `Pay - ${formatCurrency(priceInCents /100)}`}</Button>
                </CardFooter>
              </Card>
